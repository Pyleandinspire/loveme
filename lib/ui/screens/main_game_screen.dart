...
class _MainGameScreenState extends State<MainGameScreen> {
  ...
  Future<void> _sendMessage() async {
    ...
    final character = _characterManager.getCharacterById(save?.currentCharacterId ?? '');

    if (save == null || character == null || _textController.text.isEmpty || _isStreaming) return;
    ...
    await for (final chunk in aiService.streamResponse(userInput, save, character)) {
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  ...
                  itemCount: save.dialogueHistory.length + (_isStreaming ? 1 : 0),
                  itemBuilder: (context, index) {
                    if (index == save.dialogueHistory.length && _isStreaming) {
                    ...
                    return DialogueBubble(
                      ...
                      characterAvatar: dialogue.speaker != 'user' ? character.avatar : null,
                    );
                  },
                ),
              ),
